...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_SmAHTR_r1_PITTRTNUKE_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SmAHTR_r1_PITTRTNUKE_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_SmAHTR_r1_PITTRTNUKE_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "SmAHTR_r1_PITTRTNUKE") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SmAHTR_r1_PITTRTNUKE_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_SmAHTR_r1_PITTRTNUKE_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "SmAHTR_r1_PITTRTNUKE") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SmAHTR_r1_PITTRTNUKE_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_SmAHTR_r1_PITTRTNUKE_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "SmAHTR_r1_PITTRTNUKE") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SmAHTR_r1_PITTRTNUKE_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_SmAHTR_r1_PITTRTNUKE_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "SmAHTR_r1_PITTRTNUKE") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_SmAHTR_r1_PITTRTNUKE_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_SmAHTR_r1_PITTRTNUKE_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"SmAHTR_r1_PITTRTNUKE")) {
    return(sf_SmAHTR_r1_PITTRTNUKE_method_dispatcher(simstructPtr,
...
extern void SmAHTR_r1_PITTRTNUKE_initializer(void);
extern void SmAHTR_r1_PITTRTNUKE_register_exported_symbols(SimStruct* S);
extern void SmAHTR_r1_PITTRTNUKE_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  SmAHTR_r1_PITTRTNUKE_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      SmAHTR_r1_PITTRTNUKE_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    SmAHTR_r1_PITTRTNUKE_initializer();
  }
